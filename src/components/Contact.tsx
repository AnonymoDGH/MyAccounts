    ...
    <div className="page-enter">
      <div style={{
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: 14, maxWidth: 500, lineHeight: 1.7 }}>
          MYACCOUNTS is a premium digital account marketplace. We provide reliable and secure access to your favorite streaming and gaming services. Made with{' '}
          <i className="bi bi-heart-fill" style={{ color: '#e74c3c', fontSize: 12 }}></i> by free almacen.
        </p>
      </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.8 }}>
              This is a premium digital account shop. We provide access to various digital services. 
              All accounts are verified and come with a replacement warranty. 
